  ...
  return (
    <div className="genz__navbar">
      <div className="genz__navbar-links">
        <div className="genz__navbar-links_logo">
          <img src={logo} alt="logo"/>
        </div>
        <div className="genz__navbar-links_container">
          <p><a href="#home">Home</a></p>
          <p><a href="#wgenz">What is GENZ?</a></p>
      ...
      <div className="genz__navbar-menu">
        ...
        {toggleMenu && (
          <div className="genz__navbar-menu_container scale-up-center">
            ...
            <div className="genz__navbar-menu_container-links-sign">
              <p>Sign in</p>
              <button type="button">Sign up</button>
            </div>
          </div>
